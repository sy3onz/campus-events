...
(function(){
  ...
  const Icon = {
    ...
    idcard:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4.5" width="20" height="15" rx="2.2"/><circle cx="8.2" cy="11" r="2.1"/><path d="M4.8 16.2c.5-1.9 2.1-2.8 3.4-2.8s2.9.9 3.4 2.8"/><path d="M14.5 9.2h5M14.5 12.6h5"/></svg>',
  ...
  function navConfig(role){
    ...
    base.push({group:'Account', items:[
      {path:'/profile', label:'My ID', icon:'idcard'},
